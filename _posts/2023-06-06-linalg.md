...
Linear maps have a special property: they transform lines that intersect the origin to, well, lines that intersect the origin. Essentially, a linear map can only rotate a line around the origin. It cannot bend the line nor translate the line.
